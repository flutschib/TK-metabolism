...
1.001       0                %double entries for times not allowed. Use very small time difference for the switch between exposure and elimination
2           0
4           0
];
...
par.ke          = [2        1   0.01        100     1];  % elimination rate constant, d-1
par.ku          = [120      1   1           1000    1];  % uptake rate constant, L/kg/d

par.km          = [0.4     1   0.001           10       1];  % 1stBTP biotransformation rate constant [d-1]
par.kem         = [2.2     1   0.001           10       1];  % 1stBTP elimination rate constant [d-1]
...
glo.ylab{1} = ['Concentration parent (',char(181),'g/kg)'];
glo.ylab{2} = ['Concentration metabolite (',char(181),'g/kg)'];
glo.ylab{3} = ['Total chemical concentration (',char(181),'g/kg)'];
