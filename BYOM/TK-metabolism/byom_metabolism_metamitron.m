...
par.ke          = [60               1   0.01        1000     2];  % elimination rate constant, d-1
par.ku          = [2                1   0.01        100    2];  % uptake rate constant, L/kg/d

par.km          = [5               1   0.01           100       2];  % 1stBTP biotransformation rate constant [d-1]
par.kem         = [8               1   0.01           100       2];  % 1stBTP elimination rate constant [d-1]
