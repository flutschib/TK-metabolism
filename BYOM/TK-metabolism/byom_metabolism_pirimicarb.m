...
0.025	0.1679	0.3777	0.1679
0.05	0.3357	0.2098	0.2518
0.1	0.2098	0.1679	0.1679
0.2	0.1679	0.1679	0.1679
0.4	0.2098	0.1679	0.2098
0.8	0.0839	0.1679	0.1259
1.4	0.0420	0.0420	0.0839
1.425	0.0000	0.0000	0.0000
1.45	0.0000	0.0000	0.0000
1.5	0.0000	0.0000	0.0000
1.6	0.0000	0.0000	0.0000
1.8	0.0000	0.0000	0.0000
2.2	0.0000	0.0000	0.0000
2.8	0.0000	0.0000	0.0000
...
DATA{2} = [0.50    1	1   1
0	0.0000	0.0000	0.0000
0.025	0.0178	0.0401	0.0089
0.05	0.0312	0.0134	0.0178
0.1	0.0178	0.0089	0.0134
0.2	0.0223	0.0134	0.0134
0.4	0.0268	0.0134	0.0134
0.8	0.0089	0.0089	0.2185
1.4	0.0089	0.0089	0.0178
1.425	0.0045	0.0045	0.0981
1.45	0.0312	0.0045	0.0000
1.5	0.0000	0.0045	0.0045
1.6	0.0000	0.0000	0.0000
1.8	0.0000	0.0000	0.0045
2.2	0.0000	0.0000	0.0000
2.8	0.0000	0.0045	0.0045
];
...
par.ke          = [300            1   0.01        1000     2];  % elimination rate constant, d-1
par.ku          = [4            1   0.01        100    2];  % uptake rate constant, L/kg/d

par.km          = [3               1   0.01           100       2];  % 1stBTP biotransformation rate constant [d-1]
par.kem         = [20               1   0.01           100       2];  % 1stBTP elimination rate constant [d-1]
...
glo.ylab{1} = ['Concentration parent (umol/kg)'];
glo.ylab{2} = ['Concentration metabolite (umol/kg)'];
glo.ylab{3} = ['Total chemical concentration (umol/kg)'];
...
glo.stiff      = 1; % 0 = use ode45 with very strict tolerances (default, non-stiff mode); 1 = use ode15s for experiments with long time (i.e. more than one week) or imbalanced parameters
