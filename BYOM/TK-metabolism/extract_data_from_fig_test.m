...
xdata1= get(h(12,1),'XData'); % X data for all lines
...
% % Internal parent conentration (µmol/kg) 

ydata1= get(h(2,1),'YData'); % mean              
ydata2= get(h(1,1),'YData'); % upper Limit       
ydata3= get(h(3,1),'YData'); % lower limit       

% % Internal metabolite concentration (µmol/kg) 
% NOTE: Nominal exposure concentrations are marking the lines
ydata4= get(h(5,1),'YData'); % mean              
ydata5= get(h(4,1),'YData'); % upper Limit       
ydata6= get(h(6,1),'YData'); % lower limit       

% % Internal total chemical conentrations (µmol/kg) 
% NOTE: Not available from figure, therefore add parent and metabolite in the export file instead
ydata7= get(h(6,1),'YData'); % mean             
ydata8= get(h(6,1),'YData'); % upper Limit       
ydata9= get(h(6,1),'YData'); % lower limit      
